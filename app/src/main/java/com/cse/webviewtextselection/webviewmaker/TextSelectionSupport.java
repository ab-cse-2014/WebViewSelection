...
import com.cse.webviewtextselection.drag.DragController;
import com.cse.webviewtextselection.drag.DragLayer;
import com.cse.webviewtextselection.drag.DragListener;
import com.cse.webviewtextselection.drag.DragSource;
import com.cse.webviewtextselection.drag.MyAbsoluteLayout;
...
public class TextSelectionSupport implements TextSelectionControlListener, OnTouchListener, OnLongClickListener, DragListener {
    public interface SelectionListener {
        void startSelection();
        void selectionChanged(String text, Rect rect);
        void endSelection();
    }
    ...
    public void selectionChanged(String range, String text, String handleBounds, boolean isReallyChanged){
        ...
        try {
            ...
            if (mSelectionListener != null && isReallyChanged) {
                mSelectionListener.selectionChanged(text, rect);
            }
        }
    ...
    //
    @Override
    public void onDragStart(DragSource source, Object info, DragController.DragBehavior dragBehavior) {
    }
    @Override
    ...
    private Runnable drawSelectionHandlesHandler = new Runnable(){
        public void run() {
            MyAbsoluteLayout.LayoutParams startParams = (com.cse.webviewtextselection.drag.MyAbsoluteLayout.LayoutParams)mStartSelectionHandle.getLayoutParams();
            ...
            MyAbsoluteLayout.LayoutParams endParams = (com.cse.webviewtextselection.drag.MyAbsoluteLayout.LayoutParams)mEndSelectionHandle.getLayoutParams();
